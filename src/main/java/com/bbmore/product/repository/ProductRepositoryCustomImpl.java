...
public class ProductRepositoryCustomImpl implements
    ...
    private BooleanExpression searchSellStatusEq(ProductSellStatus searchSellStatus) {
        return searchSellStatus ==
                null ? null : QProduct.product.productSellStatus.eq(searchSellStatus);
    }

    private BooleanExpression regsDtsAfter(String searchDateType) {
    ...
    public Page<Product> getAdminProductPage(ProductSearchDto productSearchDto,
        ...
        List<Product> content = queryFactory
                ...
                .where(regsDtsAfter(productSearchDto.getSearchDateType()),
        ...
        long total = queryFactory
                .select(Wildcard.count).from(QProduct.product)
                .where(regsDtsAfter(productSearchDto.getSearchDateType()),
                        searchSellStatusEq(productSearchDto.getSearchSellStatus()),
    ...
    public Page<MainProductDto> getMainProductPage(ProductSearchDto productSearchDto, Pageable pageable) {
        ...
        List<MainProductDto> content = queryFactory
                ...
                .where(productImg.productImgRepYn.eq("Y"))
